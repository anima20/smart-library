...
<div class="container py-5" style="background-image: url(images/regs6.jpg);">
	<!-- <h1 style="color: white ; margin-left: 35% ; font-family: facon; font-weight: bold ; font-size: 55px">DEODRANTS</h1> -->
					...
					foreach ($res as $bk) 
					{
						?>
							<div class="col-md-3 mt-3">
								...
								<img src="images/cs/<?php echo $bk->pic; ?>" width="100%" height="200px" alt="Product Images">
								<div class="card" style="background-color: grey ; text-align: center; opacity: 0.8 ">
									<div class="card-body" style="width:100% ;  text-align: center; height:170px ; margin-top: -15px">
										<label class="card-title" style="font-weight: bold; font-size: 17px; margin-bottom: 	0px"><?php echo $bk->name; ?></label><br>
										...
										<!-- <input type="text" name="p_qty" style="width: 20%" value="1">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  -->
										<input type="hidden" name="p_na" value="<?php echo $bk->name; ?>">
										 <input type="submit" style="margin-left: -5%" name="sub" value="Renue">
