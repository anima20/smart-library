					...
					foreach ($res as $bk) 
					{
						?>
							<div class="col-md-3 mt-3">
								...
								<img src="images/mech/<?php echo $bk->pic; ?>" width="100%" height="200px" alt="Product Images">
								<div class="card" style="background-color: grey ; text-align: center; opacity: 0.8 ">
									<div class="card-body" style="width:100% ;  text-align: center; height:175px ; margin-top: -15px">
										...
										<label class="card-text" style="margin-top: -3%; font-size: 15px ; margin-bottom: 3%">Publication: <?php echo $bk->publication; ?></label><br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp 
